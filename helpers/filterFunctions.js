var filterFunctions = {
	...
	stateStatusFilter: function(landfillArray, postData) {
	...
	yearOpenedFilter: function(searchResults, yearStart, yearEnd) {

		var filteredResults = searchResults.filter(function(landFill){
			return landFill['Year Landfill Opened'] >= yearStart && landFill['Year Landfill Opened'] <= yearEnd;
		});

		return filteredResults;
	},

	getFullStateName: function(abbreviation) {
